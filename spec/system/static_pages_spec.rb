...
RSpec.describe "StaticPages", type: :system do
  describe "トップページ" do
    context "ページ全体" do
      ...
      it "ディッシュメモの文字列が存在することを確認" do
        expect(page).to have_content 'ディッシュメモ'
      end
  ...
  describe "ヘルプページ" do
    ...
    it "ディッシュメモとは？の文字列が存在することを確認" do
      expect(page).to have_content 'ディッシュメモとは？'
    end

    it "正しいタイトルが表示されることを確認" do
      expect(page).to have_title full_title('ディッシュメモとは？')
    end
  end
